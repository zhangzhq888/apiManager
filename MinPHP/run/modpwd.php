        ...
        <div>
            <form action="?act=modpwd&type=do" method="post">
                <div class="form-group">
                    <input type="password" class="form-control" name="ord_pwd" placeholder="旧密码" required="required">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" name="new_pwd" placeholder="新密码" required="required">
                </div>
                <div class="form-group">
